        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="text-center">
            <h1 className="text-4xl font-bold text-gray-900 sm:text-5xl md:text-6xl" style={{fontFamily: 'Inter, sans-serif'}}>
              Smart <span className="text-green-600">Grocery</span> Savings
            </h1>
            <p className="mt-3 max-w-md mx-auto text-base text-gray-500 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
              Find the best deals, generate meal plans, and save money on groceries with AI-powered recommendations
            </p>
            <div className="mt-8">
              <img 
